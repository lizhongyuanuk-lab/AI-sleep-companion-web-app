...
export const FIRST_LAUNCH_ONBOARDING_OPTIONS_V1: {
  ...
  q1: {
    ...
    title: "你现在更像是哪一种状态？",
    options: [
      { value: "tired_but_awake", label: "很困，但就是睡不着" },
      { value: "mind_racing", label: "脑子停不下来，一直在想" },
      { value: "anxious_or_irritated", label: "有点焦虑 / 烦躁 / 情绪乱" },
      { value: "lonely_needing_company", label: "有点孤单，想有人陪着" },
    ],
  },
  q2: {
    id: "q2_support_style",
    title: "你现在更希望我怎么陪你？",
    options: [
      { value: "help_me_sleep_fast", label: "帮我快点睡着" },
      { value: "soothe_and_chat", label: "先安抚我一下，陪我聊几句" },
      { value: "meditation_practice", label: "冥想正念练习" },
      { value: "quiet_company", label: "不用多说，安静陪我" },
    ],
  },
};
...
export const PERSONAL_ROOM_THEME_OPTIONS_V1: ThemeOption[] = [
  {
    ...
    title: "森林 / 自然",
    label: "雾林微光",
    description: "更靠近潮湿空气、树叶回响和被包裹的安静感。",
  ...
  },
  {
    ...
    title: "雨夜 / 窗边",
    label: "雨夜窗沿",
    description: "像在安全的室内听雨，适合让脑海慢慢放下来。",
  ...
  },
  {
    ...
    title: "星夜 / 开阔",
    label: "夜空留白",
    description: "更开阔、更轻，像把注意力缓慢交给远处和呼吸。",
  ...
  },
  {
    ...
    title: "温暖室内 / 安全感",
    label: "暖光房间",
    description: "偏向柔和灯光、织物包裹和被照顾的睡前氛围。",
